      ...
      <View style={styles.contentContainer}>
        <View style={[styles.dropdownContainer, styles.shadowProp]}>
          <TouchableOpacity
            ...
            style={[styles.dropdownHeader, commonStyles.alignBothCenter]}
          >
            <Text style={styles.dropdownText}>Select step</Text>
          </TouchableOpacity>
        </View>
        <Text style={[styles.textStyleHeader, commonStyles.alignSelfCenter]}>
          Counter: {counter}
        </Text>
        <Text
          style={[styles.textStyleHeaderSmall, commonStyles.alignSelfCenter]}
        >
          Step: {step}
        </Text>
        <Button
        ...
        <Button
          containerStyle={[
            styles.decrementButtonContainer,
            styles.marginTop_12,
            commonStyles.alignBothCenter,
          ]}
          text="Decrement"
